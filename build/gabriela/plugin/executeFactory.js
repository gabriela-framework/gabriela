...
function factory(moduleExecuteFactory, server) {
    return function (plugin, config) {
        return __awaiter(this, void 0, void 0, function () {
            var moduleTree, _i, _a, mdl, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        moduleTree = new ModuleTree(config, plugin.compiler.root, plugin.sharedCompiler, plugin.exposedMediator);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        for (_i = 0, _a = plugin.modules; _i < _a.length; _i++) {
                            mdl = _a[_i];
                        ...
                        return [4, moduleTree.runTree(moduleExecuteFactory.bind(null, server))];
                    case 2:
                        _b.sent();
                    ...
                    case 3:
                        ...
                        if (!plugin.hasMediators())
                            throw err_1;
                        if (plugin.hasMediators() && !plugin.mediator.onError)
                            throw err_1;
                        plugin.mediatorInstance.runOnError(plugin.mediator.onError, err_1);
                        return [3, 4];
                    case 4: return [2];
                }
            });
