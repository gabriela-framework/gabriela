...
function _assignMediatorEvents(plugin, excludes) {
    if (plugin.hasMediators()) {
        ...
        for (var _i = 0, props_1 = props; _i < props_1.length; _i++) {
            ...
            if (!excludes.includes(name_1)) {
                plugin.mediatorInstance.add(name_1, mediators[name_1]);
            }
        }
    }
}
        ...
        function run(config, executeFactory) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(plugin.modules && plugin.modules.length > 0)) return [3, 2];
                            return [4, executeFactory.call().call(null, plugin, config)];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [2];
