...
var GenericMediator = require('../genericMediator');
var hasKey = require('../../util/util').hasKey;
var LOGGING_TYPES = require('../../misc/types').LOGGING_TYPES;
function callSingleGabrielaEvent(event, rootCompiler, err) {
    var mediator = GenericMediator.create(rootCompiler);
    if (err)
        return mediator.runOnError(event, this, err);
    mediator.callEvent(event, this);
}
function runOnAppStarted(events, rootCompiler, err) {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                ...
                if (events[GABRIELA_EVENTS.ON_CATCH_ERROR]) {
                    return [2, callSingleGabrielaEvent.call(this, events[GABRIELA_EVENTS.ON_CATCH_ERROR], rootCompiler, eventError)];
                }
                throw eventError;
            }
            return [2];
...
module.exports = {
    callSingleGabrielaEvent: callSingleGabrielaEvent,
    runOnAppStarted: runOnAppStarted
};
//# sourceMappingURL=gabrielaEventUtils.js.map